...
export const DEFAULT_CONFIG: SimulationConfig = {
  ...
  population: {
    powerShares: { low: 0.75, mid: 0.2, high: 0.05 },
    basePower: { low: 460_000, mid: 900_000, high: 1_600_000 },
    powerSigma: { low: 0.18, mid: 0.18, high: 0.22 },
    weakFormationScale: { low: 0.45, mid: 0.52, high: 0.58 },
  },
